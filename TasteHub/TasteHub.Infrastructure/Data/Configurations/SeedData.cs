    ...
    internal class SeedData
    {
        ...
        {            
            ChocolateCheesecake = new Recipe()
            {
                ...
                Image = File.ReadAllBytes(Path.Combine(@"..\..\TasteHub\TasteHub.Infrastructure\Images", "Cheesecake.png")),
            ...
            Burger = new Recipe()
            {
                Id = 2,
                Title = "Burger",
                Ingredients = "beef - 900 g (chopped); pickles - 1 pc.; green onion - 2 - 3 feathers; salt; pepper; ketchup",
                Instructions = "Cucumbers and onions are finely chopped. Add the meat, black pepper and salt. Mix well and divide into 6 balls. The balls are pressed until they are flat, placed in a pan and baked in a moderate oven. They are garnished with ketchup.",
                Image = File.ReadAllBytes(Path.Combine(@"..\..\TasteHub\TasteHub.Infrastructure\Images", "Burger.png")),
                CreationDate = DateTime.Now,
                CreatorId = Guest.Id,
