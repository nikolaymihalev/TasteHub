        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false, comment: "Recipe description"),
                    Ingredients = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false, comment: "Recipe ingredients"),
                    Instructions = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false, comment: "Recipe instructions"),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date the recipe was created"),
                    CreatorId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Recipe creator identifier"),
                    CategoryId = table.Column<int>(type: "int", nullable: false, comment: "Recipe category identifier")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date the comment was created"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "Identifier of the user"),
                    RecipeId = table.Column<int>(type: "int", nullable: false, comment: "Identifier of the recipe")
                },
                constraints: table =>
                {
